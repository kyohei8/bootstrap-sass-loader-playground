module.exports = {
  // 事前に読み込ませるファイル
  // 定義した変数がbootstrapに書き込まれる
  preBootstrapCustomizations: "./styles/_pre-bs-custom.scss",

  // bootstrapが読み込まれた後（preBootstrapCustomizationsまたは_variables.scssのあとで読み込まれる）
  // 別の変数値で上書きする場合に利用する
  bootstrapCustomizations: "./styles/_bs-custom.scss",
